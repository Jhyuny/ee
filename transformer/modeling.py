...
class BertPreTrainedModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        # Load config
        #------------------------------------------------------ (new)
        # # Hugging Face model name 사용
        # model_name = pretrained_model_name_or_path  # 예시

        # # 자동으로 Hugging Face에서 config 다운로드
        ...
        for key in state_dict.keys():
            ...
            #------------------------------------------------------  
            if not new_key.startswith("bert.") and any(new_key.startswith(k) for k in [
